...
2. application.py for Streamlit to run in a browser window, run "streamlit run application.py" in the terminal (UI, Option I)
- If using the UI, make sure to run Ctrl + C in the terminal to close the application.
3. inference_post_training.py to run as a separate window on your computer (no UI, Option II)
